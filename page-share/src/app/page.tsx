        ...
        <div className="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 dark:bg-gray-900">
              <tr>
                <th className="px-4 py-3 text-left font-medium text-gray-500 dark:text-gray-400">제목</th>
                <th className="px-4 py-3 text-left font-medium text-gray-500 dark:text-gray-400 hidden md:table-cell">원본 URL</th>
                <th className="px-4 py-3 text-right font-medium text-gray-500 dark:text-gray-400 hidden sm:table-cell">크기</th>
                <th className="px-4 py-3 text-right font-medium text-gray-500 dark:text-gray-400">저장일</th>
                {admin && (
                  <th className="px-4 py-3 text-right font-medium text-gray-500 dark:text-gray-400">관리</th>
                )}
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {archives.map((archive) => (
                <tr
                  key={archive.id}
                  className={`hover:bg-gray-50 dark:hover:bg-gray-900/60 transition-colors ${archive.is_private ? "opacity-60" : ""}`}
                >
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1.5">
                      ...
                      <a
                        ...
                        className="font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 line-clamp-1"
                      >
                        {archive.title}
                      </a>
                    </div>
                  ...
                  <td className="px-4 py-3 hidden md:table-cell">
                    <a
                      ...
                      className="text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 truncate block max-w-xs"
                    >
