...
export default async function PrivacyPage({
  ...
  const doc = getLegalDocument(lang as Lang, "privacy");
    ...
    <Section>
      <Container>
        <div className="flex items-center justify-between mb-8">
          ...
          <LanguageToggle currentLang={lang as Lang} currentType="privacy" />
        </div>
        <p className="text-sm text-text-secondary mb-6">
          Effective: {doc.effectiveDate}
        </p>
        <LegalTabs currentType="privacy" currentLang={lang as Lang} />
